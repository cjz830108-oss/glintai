    ...
    <div class="wrap">
      ...
      <div class="price-grid">
        ...
        <div class="plan featured">
          ...
          <div class="price-note">or <b>$79 / year</b> — Save 34%</div>
          <ul>
          ...
          <div id="pp-pro-yearly" class="pp-box"></div>
          <p class="price-fine">Yearly plan is set up in PayPal (see config notes).</p>
        </div>
        <div class="plan">
          <h3>Team</h3>
