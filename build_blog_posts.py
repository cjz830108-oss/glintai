...
POSTS = [
    ...
    dict(
        slug="how-to-write-a-meta-title",
        title="How to Write a Meta Title That Ranks (Free, No Signup)",
        description="Write a meta title that ranks and earns the click - free, no signup. Learn length, structure, and keywords, and preview it in a SERP tool. Try it now.",
        keywords="how to write a meta title, meta title that ranks, write meta title free, meta title length seo, meta title no signup",
        category="SEO",
        accent="#00f0ff",
        readtime=10,
        related=[
            ("Best Free SERP Preview Tool", "/blog/best-free-serp-preview-tool.html"),
            ("Meta Descriptions That Boost CTR", "/blog/meta-description-ctr-guide.html"),
            ("YouTube Title Generator Guide", "/blog/youtube-title-generator-guide.html"),
            ("Best Free Markdown to HTML Converter", "/blog/best-free-markdown-to-html-converter.html"),
        ...
        sources=[
            ("Google Search Central: Title Links", "https://developers.google.com/search/docs/appearance/title-link", "How titles are generated and truncated."),
            ("Google Search Central: Snippets", "https://developers.google.com/search/docs/appearance/snippet", "How snippets appear in results."),
            ("Nielsen Norman Group: Page Titles", "https://www.nngroup.com/articles/web-page-titles-and-search-engine-optimization/", "Title best practices."),
            ("Glint AI SERP Preview", "/tools/serp-preview.html", "Preview before publishing."),
            ("Glint AI Markdown to HTML", "/tools/markdown-to-html.html", "Free converter."),
        ],
        takeaways=[
            "Your meta title wins or loses the click - write it for the reader, not just the crawler.",
            "Google rewrites weak titles, so clarity and specificity keep yours intact.",
            "Count pixels, not just characters - width is what gets truncated in results.",
            "Make every title unique across the site to avoid competing with yourself.",
            "Preview the title in a SERP tool before you publish it.",
        ],
        closing='Write your title with the free <a href="/tools/serp-preview.html">SERP preview tool</a> and the <a href="/blog/best-free-serp-preview-tool.html">SERP guide</a>, then publish with confidence.',
    ),
    dict(
        slug="how-to-paraphrase-a-paragraph",
        title="How to Paraphrase a Paragraph Without Plagiarizing (Free)",
        description="Paraphrase a paragraph without plagiarizing - free, no signup. Learn the rebuild-the-meaning method, see a worked example, and avoid the synonym-swap trap. Try it now.",
        keywords="how to paraphrase a paragraph, paraphrase without plagiarizing, paraphrase free no signup, how to paraphrase properly, paraphrase vs spinning",
        category="Writing",
        accent="#00f0ff",
        readtime=10,
        related=[
            ...
            ("Free AI Humanizer No Signup", "/blog/free-ai-humanizer-no-signup.html"),
            ("Best Free Word Counter Tools", "/blog/best-free-word-counter-tools-2026.html"),
            ("AI Tools for Freelancers", "/blog/ai-tools-for-freelancers-2026.html"),
            ("Try the free Paraphraser", "/tools/paraphraser.html"),
        ],
        sources=[
            ("Purdue OWL: Paraphrasing", "https://owl.purdue.edu/owl/research_and_citation/using_research/quoting_paraphrasing/index.html", "Academic paraphrasing guidance."),
            ("Wikipedia: Paraphrase", "https://en.wikipedia.org/wiki/Paraphrase", "Definition and history."),
            ("Glint AI Paraphraser", "/tools/paraphraser.html", "Free, no signup."),
            ("Glint AI Humanizer", "/tools/ai-humanizer.html", "Smooth machine text."),
            ("Glint AI Word Counter", "/tools/word-counter.html", "Check length."),
        ],
        takeaways=[
            "Paraphrasing rebuilds meaning in your own words, not just swaps synonyms.",
            "Read, cover the source, then write from memory to avoid echoing structure.",
            "Cite the source even when the words are yours - the idea is still the author's.",
            "A summary shrinks; a paraphrase keeps the length but changes the wording.",
            "Edit after a tool pass so the result reads human, not spun.",
        ],
        closing='Rewrite with the free <a href="/tools/paraphraser.html">paraphraser</a> and smooth it with the <a href="/tools/ai-humanizer.html">humanizer</a> - both run in your browser.',
    ),
    dict(
        slug="how-to-detect-ai-in-student-work",
        title="How to Detect AI in Student Work (Free, No Upload)",
        description="Detect AI in student work the fair way - free, no upload. Learn what detectors measure, why scores are not proof, and how to avoid false accusations. Try it now.",
        keywords="how to detect ai in student work, detect ai writing students, ai detector for teachers, ai detection false positives, ai content detector no upload",
        category="Education",
        accent="#ff2e97",
        readtime=11,
        related=[
            ("Free AI Content Detector No Upload", "/blog/free-ai-content-detector-no-upload.html"),
            ("AI Tools for Researchers", "/blog/ai-tools-for-researchers-2026.html"),
            ("Does Google Detect AI Content", "/blog/does-google-detect-ai-content.html"),
            ("Free AI Humanizer No Signup", "/blog/free-ai-humanizer-no-signup.html"),
            ("Try the free AI Detector", "/tools/ai-content-detector.html"),
        ],
        sources=[
            ("OpenAI: Safety Best Practices", "https://platform.openai.com/docs/guides/safety-best-practices", "Model limitations and cautions."),
            ("arXiv: DetectGPT", "https://arxiv.org/abs/2301.11305", "Research on AI text detection."),
            ("Glint AI Content Detector", "/tools/ai-content-detector.html", "Free, no upload."),
            ("Glint: Does Google Detect AI", "/blog/does-google-detect-ai-content.html", "Policy context."),
            ("Glint AI Researchers Guide", "/blog/ai-tools-for-researchers-2026.html", "Related toolkit."),
        ],
        takeaways=[
            "A detector estimates probability; it is a hint, never proof of cheating.",
            "False positives hit careful human writers, especially non-native ones.",
            "Use the score to start a conversation, not to fail a student.",
            "Pair the score with drafts, a conference, and prior work.",
            "Keep student text private with a no-upload, browser-based tool.",
        ],
        closing='Screen work with the free <a href="/tools/ai-content-detector.html">AI content detector</a> - it runs in your browser and never stores the text.',
    ),
    dict(
        slug="how-to-remove-background-from-image-free",
        title="How to Remove a Background from an Image Free (No Upload)",
        description="Remove a background from an image free - no upload, no signup. Learn how to get a clean cutout and keep private photos on your device. Try it now.",
        keywords="remove background from image free, background remover no upload, free background remover no signup, remove bg from photo, transparent png free",
        category="Design",
        accent="#a855f7",
        readtime=10,
        related=[
            ("AI Tools for Social Media Managers", "/blog/ai-tools-for-social-media-managers-2026.html"),
            ("AI Tools for Ecommerce", "/blog/ai-tools-for-ecommerce-2026.html"),
            ("How to Create Alt Text for Images", "/blog/how-to-create-alt-text-for-images.html"),
            ("Free AI Tools for Developers", "/blog/free-ai-tools-developers.html"),
            ("Try the free Background Remover", "/tools/background-remover.html"),
        ],
        sources=[
            ("MDN: Image File Types", "https://developer.mozilla.org/en-US/docs/Web/Media/Formats/Image_types", "Image format reference."),
            ("W3C: PNG Spec", "https://www.w3.org/TR/PNG/", "Transparency standard."),
            ("Glint AI Background Remover", "/tools/background-remover.html", "Free, no upload."),
            ("Glint: Alt Text Guide", "/blog/how-to-create-alt-text-for-images.html", "Accessibility."),
            ("Glint: Ecommerce AI Guide", "/blog/ai-tools-for-ecommerce-2026.html", "Listing workflow."),
        ],
        takeaways=[
            "Background removal isolates the subject and makes the rest transparent.",
            "A browser-based tool keeps private photos on your device - no server copy.",
            "Plain, high-contrast backgrounds give the cleanest edges.",
            "Export as PNG to preserve transparency; JPEG flattens it.",
            "Check hair and translucent edges, where automatic tools struggle.",
        ],
        closing='Cut out images with the free <a href="/tools/background-remover.html">background remover</a> - it processes in your browser with no upload.',
    ),
    dict(
        slug="how-to-reduce-reading-grade-level",
        title="How to Reduce Reading Grade Level (Free, No Signup)",
        description="Reduce reading grade level and reach more readers - free, no signup. Learn the plain-language method, see a before-after, and avoid dumbing down. Try it now.",
        keywords="reduce reading grade level, lower reading level free, improve readability grade, plain language tool, readability analyzer no signup",
        category="Writing",
        accent="#00f0ff",
        readtime=10,
        related=[
            ("Free Readability Checker", "/blog/free-readability-checker.html"),
            ("Best Free Word Counter Tools", "/blog/best-free-word-counter-tools-2026.html"),
            ("AI Writing Tools for Non-Native English", "/blog/ai-writing-tools-non-native-english.html"),
            ("How to Convert Markdown to HTML", "/blog/how-to-convert-markdown-to-html.html"),
            ("Try the free Readability Analyzer", "/tools/word-readability-analyzer.html"),
        ],
        sources=[
            ("Hemingway Editor", "https://hemingwayapp.com/", "Grade-level guidance."),
            ("PlainLanguage.gov", "https://www.plainlanguage.gov/guidelines/", "Plain writing standards."),
            ("Glint AI Readability Analyzer", "/tools/word-readability-analyzer.html", "Free, no signup."),
            ("Glint AI Word Counter", "/tools/word-counter.html", "Count and check."),
            ("Glint: Non-Native English Tools", "/blog/ai-writing-tools-non-native-english.html", "Related help."),
        ],
        takeaways=[
            "A high grade level quietly halves your audience - lower it to reach more.",
            "Short sentences and plain words clear the path without dumbing down.",
            "Target grade 6 to 8 for general readers, higher for specialists.",
            "Vary sentence length so the text does not read like a robot.",
            "Measure, edit, re-measure with a readability tool.",
        ],
        closing='Measure with the free <a href="/tools/word-readability-analyzer.html">readability analyzer</a> and keep sections tight with the <a href="/tools/word-counter.html">word counter</a>.',
    ),
    dict(
        slug="how-to-convert-markdown-to-html",
        title="How to Convert Markdown to HTML Free (No Upload, No Signup)",
        description="Convert Markdown to HTML free - no upload, no signup. Learn what to check, see a worked example, and avoid broken tags. Try it now.",
        keywords="convert markdown to html free, markdown to html no upload, markdown to html converter, md to html online free, browser markdown converter",
        category="Developers",
        accent="#39ff14",
        readtime=10,
        related=[
            ...
            ("Best Free JSON Formatter", "/blog/best-free-json-formatter.html"),
            ("Why Marketers Need a JSON Formatter", "/blog/why-marketers-need-a-json-formatter.html"),
            ("How to Convert CSV to JSON", "/blog/how-to-convert-csv-to-json.html"),
            ("Try the free Markdown Converter", "/tools/markdown-to-html.html"),
        ],
        sources=[
            ("CommonMark Spec", "https://spec.commonmark.org/", "Markdown standardization."),
            ("MDN: HTML Elements", "https://developer.mozilla.org/en-US/docs/Web/HTML/Element", "HTML element reference."),
            ("Glint AI Markdown to HTML", "/tools/markdown-to-html.html", "Free converter."),
            ("Glint AI JSON Formatter", "/tools/json-formatter.html", "Pretty-print JSON."),
            ("Glint: CSV to JSON Guide", "/blog/how-to-convert-csv-to-json.html", "Related conversion."),
        ],
        takeaways=[
            "Markdown to HTML turns plain text into structured tags automatically.",
            "A browser-based converter keeps unpublished drafts on your device.",
            "Confirm code blocks are escaped so they render as code, not markup.",
            "Preview the output for unclosed tags before you publish.",
            "Chain it with a JSON formatter when docs carry config snippets.",
        ],
        closing='Convert with the free <a href="/tools/markdown-to-html.html">Markdown to HTML tool</a> and pretty-print configs with the <a href="/tools/json-formatter.html">JSON formatter</a>.',
    ),
    dict(
        slug="how-to-create-a-strong-password",
        title="How to Create a Strong Password (Free Generator, No Signup)",
        description="Create a strong password free - no signup, no upload. Learn why length beats complexity and generate safe values in your browser. Try it now.",
        keywords="how to create a strong password, strong password generator free, password generator no upload, length vs complexity, secure password no signup",
        category="Security",
        accent="#ffb020",
        readtime=10,
        related=[
        ...
        sources=[
            ...
            ("CISA: Strong Passwords", "https://www.cisa.gov/secure-our-world/strong-passwords", "Practical advice."),
            ("OWASP Cheat Sheets", "https://owasp.org/www-project-cheat-sheets/", "Security best practices."),
            ("Have I Been Pwned", "https://haveibeenpwned.com/", "Check breached values."),
            ("Glint AI Password Generator", "/tools/password-generator.html", "Free, no upload."),
        ],
        takeaways=[
            "Strength comes from length and randomness, not clever patterns.",
            "A long random passphrase beats a short complex-looking password.",
            "Never reuse a password - one breach then unlocks everything.",
            "Use a manager so each account gets a unique strong value.",
            "Generate locally so the value is never transmitted.",
        ],
        closing='Generate with the free <a href="/tools/password-generator.html">password generator</a> and handle keys with the <a href="/blog/generate-api-keys-safely.html">API key guide</a>.',
    ),
    dict(
        slug="how-to-write-a-resume-summary",
        title="How to Write a Resume Summary That Gets Interviews (Free)",
        description="Write a resume summary that gets interviews - free, no signup. Learn the role-plus-proof formula, see a before-after, and tailor per application. Try it now.",
        keywords="how to write a resume summary, resume summary examples, resume summary vs objective, write resume summary free, resume summary that gets interviews",
        category="Career",
        accent="#ff2e97",
        readtime=10,
        related=[
            ("Try the free Bio and Resume Generator", "/tools/bio-resume-generator.html"),
            ("Write a Professional Bio Guide", "/blog/write-professional-bio-guide.html"),
            ("Best AI Resume Builder Tools", "/blog/best-ai-resume-builder-tools-2026.html"),
            ("AI Tools for Job Seekers", "/blog/ai-tools-for-job-seekers-2026.html"),
            ("Free AI Humanizer No Signup", "/blog/free-ai-humanizer-no-signup.html"),
        ],
        sources=[
            ("Harvard Career Services: Resumes", "https://careerservices.fas.harvard.edu/resources/resumes-cover-letters/", "Resume guidance."),
            ("Indeed: Resume Summary", "https://www.indeed.com/career-advice/resumes-cover-letters/resume-summary", "Summary examples."),
            ("Glint AI Bio Generator", "/tools/bio-resume-generator.html", "Free, no signup."),
            ("Glint: Professional Bio Guide", "/blog/write-professional-bio-guide.html", "Extend to a profile."),
            ("Glint: Job Seekers AI Guide", "/blog/ai-tools-for-job-seekers-2026.html", "Full application."),
        ],
        takeaways=[
            "A summary shows what you bring; an objective shows what you want.",
            "Lead with role, years, and one proof - two or three lines max.",
            "Metrics beat adjectives; a number proves the claim.",
            "Tailor per application by mirroring the job's keywords.",
            "Use a generator for a draft, then edit for truth and voice.",
        ],
...
HERO_ALT = {
    ...
    "how-to-write-a-meta-title": "SERP preview showing a meta title fitting within the search result pixel width",
    "how-to-paraphrase-a-paragraph": "Original paragraph and a rebuilt paraphrase shown side by side",
    "how-to-detect-ai-in-student-work": "AI detection score panel showing a probability estimate for a student text",
    "how-to-remove-background-from-image-free": "Product photo with its background removed onto a clean white surface",
    "how-to-reduce-reading-grade-level": "Readability report showing a grade level dropping after an edit",
